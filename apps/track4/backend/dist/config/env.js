...
exports.env = {
    ...
    circleWebhookSecret: (0, validateEnv_1.validateEnv)("CIRCLE_WEBHOOK_SECRET"),
    arcRpcUrl: (0, validateEnv_1.validateEnv)("ARC_RPC_URL"),
    arcChainId: (0, validateEnv_1.validateEnv)("ARC_CHAIN_ID", "arc-testnet"),
