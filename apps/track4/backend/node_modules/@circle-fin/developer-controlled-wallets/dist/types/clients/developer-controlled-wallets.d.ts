 ...
 *
 * @export
 * @interface CreateTransferTransactionForDeveloperRequestBlockchain
 */
interface CreateTransferTransactionForDeveloperRequestBlockchain {
}
...
interface CreateTransferTransactionForDeveloperRequest {
    ...
    /**
     *
     * @type {CreateTransferTransactionForDeveloperRequestBlockchain}
     * @memberof CreateTransferTransactionForDeveloperRequest
     */
 ...
 *
 * @export
 * @interface FeeParametersResponseData
 */
interface FeeParametersResponseData {
    /**
     *
     * @type {FeeParameters}
     * @memberof FeeParametersResponseData
     */
    'high'?: FeeParameters;
    /**
     *
 ...
 *
 * @export
 * @interface FeeParametersResponse
 */
interface FeeParametersResponse {
    /**
     *
     * @type {FeeParametersResponseData}
     * @memberof FeeParametersResponse
     */
    'data': FeeParametersResponseData;
}
 ...
 * @enum {string}
 */
declare const TransferBlockchain: {
    readonly Eth: "ETH";
    readonly EthSepolia: "ETH-SEPOLIA";
    readonly Avax: "AVAX";
    readonly AvaxFuji: "AVAX-FUJI";
...
type TransferBlockchain = typeof TransferBlockchain[keyof typeof TransferBlockchain];
...
declare const SigningApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    signDelegateAction: (signDelegateActionRequest: SignDelegateActionRequest, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    signMessage: (signMessageRequest: SignMessageRequest, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    signTransaction: (signTransactionRequest: SignTransactionRequest, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * | Sign the EIP-712 typed structured data from a specified developer-controlled wallet. You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body. This endpoint only supports Ethereum and EVM-compatible blockchains. Please note that not all apps currently support Smart Contract Accounts (SCA); the difference between Ethereum\'s EOA and SCA can be found in the [account types guide](https://developers.circle.com/w3s/docs/programmable-wallets-account-types). You can also check the list of Ethereum apps that support SCA: https://eip1271.io/.
     ...
     * @throws {RequiredError}
     */
    signTypedData: (signTypedDataRequest: SignTypedDataRequest, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
declare const SigningApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    signDelegateAction(signDelegateActionRequest: SignDelegateActionRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SignDelegateActionResponse>>;
    /**
     * Sign a message from a specified developer-controlled wallet. This endpoint supports message signing for Ethereum-based blockchains (using EIP-191), Solana and Aptos (using Ed25519 signatures). Note that Smart Contract Accounts (SCA) are specific to Ethereum and EVM-compatible chains. The difference between Ethereum\'s EOA and SCA can be found in the [account types guide](https://developers.circle.com/w3s/docs/programmable-wallets-account-types). You can also check the list of Ethereum Dapps that support SCA: https://eip1271.io/.\"  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.
     * @summary Sign message
     * @param {SignMessageRequest} signMessageRequest Schema for the request payload to sign a message.
     ...
     * @throws {RequiredError}
     */
    signMessage(signMessageRequest: SignMessageRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SignatureResponse>>;
    /**
     * Sign a transaction from a specific developer-controlled wallet.  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.  NOTE: This endpoint is only available for the following chains: `SOL`, `SOL-DEVNET`, `NEAR`, `NEAR-TESTNET`, `EVM`, `EVM-TESTNET`. Each chain defines its own standard, please refer to [Signing APIs doc](https://learn.circle.com/w3s/signing-apis).
     * @summary Sign transaction
     * @param {SignTransactionRequest} signTransactionRequest Schema for the request payload to sign a transaction.
     ...
     * @throws {RequiredError}
     */
    signTransaction(signTransactionRequest: SignTransactionRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SignTransactionResponse>>;
    /**
     * | Sign the EIP-712 typed structured data from a specified developer-controlled wallet. You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body. This endpoint only supports Ethereum and EVM-compatible blockchains. Please note that not all apps currently support Smart Contract Accounts (SCA); the difference between Ethereum\'s EOA and SCA can be found in the [account types guide](https://developers.circle.com/w3s/docs/programmable-wallets-account-types). You can also check the list of Ethereum apps that support SCA: https://eip1271.io/.
     * @summary Sign typed data
     * @param {SignTypedDataRequest} signTypedDataRequest Schema for the request payload to sign typed data.
     ...
     * @throws {RequiredError}
     */
    signTypedData(signTypedDataRequest: SignTypedDataRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SignatureResponse>>;
};
/**
...
declare const SigningApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    signDelegateAction(signDelegateActionRequest: SignDelegateActionRequest, xRequestId?: string, options?: any): AxiosPromise<SignDelegateActionResponse>;
    /**
     * Sign a message from a specified developer-controlled wallet. This endpoint supports message signing for Ethereum-based blockchains (using EIP-191), Solana and Aptos (using Ed25519 signatures). Note that Smart Contract Accounts (SCA) are specific to Ethereum and EVM-compatible chains. The difference between Ethereum\'s EOA and SCA can be found in the [account types guide](https://developers.circle.com/w3s/docs/programmable-wallets-account-types). You can also check the list of Ethereum Dapps that support SCA: https://eip1271.io/.\"  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.
     * @summary Sign message
     * @param {SignMessageRequest} signMessageRequest Schema for the request payload to sign a message.
     ...
     * @throws {RequiredError}
     */
    signMessage(signMessageRequest: SignMessageRequest, xRequestId?: string, options?: any): AxiosPromise<SignatureResponse>;
    /**
     * Sign a transaction from a specific developer-controlled wallet.  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.  NOTE: This endpoint is only available for the following chains: `SOL`, `SOL-DEVNET`, `NEAR`, `NEAR-TESTNET`, `EVM`, `EVM-TESTNET`. Each chain defines its own standard, please refer to [Signing APIs doc](https://learn.circle.com/w3s/signing-apis).
     * @summary Sign transaction
     * @param {SignTransactionRequest} signTransactionRequest Schema for the request payload to sign a transaction.
     ...
     * @throws {RequiredError}
     */
    signTransaction(signTransactionRequest: SignTransactionRequest, xRequestId?: string, options?: any): AxiosPromise<SignTransactionResponse>;
    /**
     * | Sign the EIP-712 typed structured data from a specified developer-controlled wallet. You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body. This endpoint only supports Ethereum and EVM-compatible blockchains. Please note that not all apps currently support Smart Contract Accounts (SCA); the difference between Ethereum\'s EOA and SCA can be found in the [account types guide](https://developers.circle.com/w3s/docs/programmable-wallets-account-types). You can also check the list of Ethereum apps that support SCA: https://eip1271.io/.
     * @summary Sign typed data
     * @param {SignTypedDataRequest} signTypedDataRequest Schema for the request payload to sign typed data.
     ...
     * @throws {RequiredError}
     */
    signTypedData(signTypedDataRequest: SignTypedDataRequest, xRequestId?: string, options?: any): AxiosPromise<SignatureResponse>;
};
/**
...
declare class SigningApi extends BaseAPI {
     ...
     * @memberof SigningApi
     */
    signDelegateAction(signDelegateActionRequest: SignDelegateActionRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<SignDelegateActionResponse, any, {}>>;
    /**
     * Sign a message from a specified developer-controlled wallet. This endpoint supports message signing for Ethereum-based blockchains (using EIP-191), Solana and Aptos (using Ed25519 signatures). Note that Smart Contract Accounts (SCA) are specific to Ethereum and EVM-compatible chains. The difference between Ethereum\'s EOA and SCA can be found in the [account types guide](https://developers.circle.com/w3s/docs/programmable-wallets-account-types). You can also check the list of Ethereum Dapps that support SCA: https://eip1271.io/.\"  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.
     * @summary Sign message
     * @param {SignMessageRequest} signMessageRequest Schema for the request payload to sign a message.
     ...
     * @memberof SigningApi
     */
    signMessage(signMessageRequest: SignMessageRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<SignatureResponse, any, {}>>;
    /**
     * Sign a transaction from a specific developer-controlled wallet.  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.  NOTE: This endpoint is only available for the following chains: `SOL`, `SOL-DEVNET`, `NEAR`, `NEAR-TESTNET`, `EVM`, `EVM-TESTNET`. Each chain defines its own standard, please refer to [Signing APIs doc](https://learn.circle.com/w3s/signing-apis).
     * @summary Sign transaction
     * @param {SignTransactionRequest} signTransactionRequest Schema for the request payload to sign a transaction.
     ...
     * @memberof SigningApi
     */
    signTransaction(signTransactionRequest: SignTransactionRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<SignTransactionResponse, any, {}>>;
    /**
     * | Sign the EIP-712 typed structured data from a specified developer-controlled wallet. You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body. This endpoint only supports Ethereum and EVM-compatible blockchains. Please note that not all apps currently support Smart Contract Accounts (SCA); the difference between Ethereum\'s EOA and SCA can be found in the [account types guide](https://developers.circle.com/w3s/docs/programmable-wallets-account-types). You can also check the list of Ethereum apps that support SCA: https://eip1271.io/.
     * @summary Sign typed data
     * @param {SignTypedDataRequest} signTypedDataRequest Schema for the request payload to sign typed data.
     ...
     * @memberof SigningApi
     */
    signTypedData(signTypedDataRequest: SignTypedDataRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<SignatureResponse, any, {}>>;
}
...
declare const TransactionsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionAccelerate: (id: string, accelerateTransactionForDeveloperRequest: AccelerateTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionCancel: (id: string, cancelTransactionForDeveloperRequest: CancelTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionContractExecution: (createContractExecutionTransactionForDeveloperRequest: CreateContractExecutionTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionTransfer: (createTransferTransactionForDeveloperRequest: CreateTransferTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionWalletUpgrade: (createWalletUpgradeTransactionForDeveloperRequest: CreateWalletUpgradeTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createTransactionEstimateFee: (estimateContractExecutionTransactionFeeRequest: EstimateContractExecutionTransactionFeeRequest, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createTransferEstimateFee: (estimateTransferTransactionFeeRequest: EstimateTransferTransactionFeeRequest, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @param {AccountType} [accountType] Query by the account type.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getFeeParameters: (blockchain?: Blockchain, accountType?: AccountType, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getTransaction: (id: string, txType?: TransactionType, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
declare const TransactionsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionAccelerate(id: string, accelerateTransactionForDeveloperRequest: AccelerateTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AccelerateTransactionForDeveloper>>;
    /**
     * Cancels a specified transaction from a developer-controlled wallet. Gas fees may still be incurred.  This is a best-effort operation, it won\'t be effective if the original transaction has already been processed by the blockchain.
     * @summary Cancel a transaction
     * @param {string} id The universally unique identifier of the resource.
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionCancel(id: string, cancelTransactionForDeveloperRequest: CancelTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CancelTransactionForDeveloper>>;
    /**
     * Creates a transaction which executes a smart contract. ABI parameters must be passed in the request. Related transactions may be submitted as a batch transaction in a single call.  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.
     * @summary Create a contract execution transaction
     * @param {CreateContractExecutionTransactionForDeveloperRequest} createContractExecutionTransactionForDeveloperRequest Create transaction for developer request
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionContractExecution(createContractExecutionTransactionForDeveloperRequest: CreateContractExecutionTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateContractExecutionTransactionForDeveloper>>;
    /**
     * Initiates an on-chain digital asset transfer from a specified developer-controlled wallet.  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.
     * @summary Create a transfer transaction
     * @param {CreateTransferTransactionForDeveloperRequest} createTransferTransactionForDeveloperRequest Create transaction for developer request
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionTransfer(createTransferTransactionForDeveloperRequest: CreateTransferTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateTransferTransactionForDeveloperResponse>>;
    /**
     * Creates a transaction which upgrades a wallet.
     * @summary Create a wallet upgrade transaction
     * @param {CreateWalletUpgradeTransactionForDeveloperRequest} createWalletUpgradeTransactionForDeveloperRequest Creates a transaction for a developer request.
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionWalletUpgrade(createWalletUpgradeTransactionForDeveloperRequest: CreateWalletUpgradeTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateWalletUpgradeTransactionForDeveloper>>;
    /**
     * Estimates gas fees that will be incurred for a contract execution transaction, given its ABI parameters and blockchain.
     * @summary Estimate fee for a contract execution transaction
     * @param {EstimateContractExecutionTransactionFeeRequest} estimateContractExecutionTransactionFeeRequest Estimate transaction fee request
     ...
     * @throws {RequiredError}
     */
    createTransactionEstimateFee(estimateContractExecutionTransactionFeeRequest: EstimateContractExecutionTransactionFeeRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EstimateTransactionFee>>;
    /**
     * Estimates gas fees that will be incurred for a transfer transaction; given its amount, blockchain, and token.
     * @summary Estimate fee for a transfer transaction
     * @param {EstimateTransferTransactionFeeRequest} estimateTransferTransactionFeeRequest Estimate transaction fee request
     ...
     * @throws {RequiredError}
     */
    createTransferEstimateFee(estimateTransferTransactionFeeRequest: EstimateTransferTransactionFeeRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EstimateTransactionFee>>;
    /**
     * Confirms that a specified address is valid for a given token on a certain blockchain.
     * @summary Validate an address
     * @param {ValidateAddressRequest} validateAddressRequest Validate address request
     ...
     * @throws {RequiredError}
     */
    getFeeParameters(blockchain?: Blockchain, accountType?: AccountType, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeeParametersResponse>>;
    /**
     * For a nonce-supported blockchain, get the lowest nonce transaction that\'s in QUEUED or SENT or STUCK state for the provided wallet.
     * @summary Get the lowest nonce pending transaction for a wallet
     * @param {Blockchain} [blockchain] Filter by blockchain.
     ...
     * @throws {RequiredError}
     */
    getTransaction(id: string, txType?: TransactionType, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransactionResponse>>;
    /**
     * Lists all transactions. Includes details such as status, source/destination, and transaction hash.
     * @summary List transactions
     * @param {Blockchain} [blockchain] Filter by blockchain.
...
declare const TransactionsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionAccelerate(id: string, accelerateTransactionForDeveloperRequest: AccelerateTransactionForDeveloperRequest, xRequestId?: string, options?: any): AxiosPromise<AccelerateTransactionForDeveloper>;
    /**
     * Cancels a specified transaction from a developer-controlled wallet. Gas fees may still be incurred.  This is a best-effort operation, it won\'t be effective if the original transaction has already been processed by the blockchain.
     * @summary Cancel a transaction
     * @param {string} id The universally unique identifier of the resource.
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionCancel(id: string, cancelTransactionForDeveloperRequest: CancelTransactionForDeveloperRequest, xRequestId?: string, options?: any): AxiosPromise<CancelTransactionForDeveloper>;
    /**
     * Creates a transaction which executes a smart contract. ABI parameters must be passed in the request. Related transactions may be submitted as a batch transaction in a single call.  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.
     * @summary Create a contract execution transaction
     * @param {CreateContractExecutionTransactionForDeveloperRequest} createContractExecutionTransactionForDeveloperRequest Create transaction for developer request
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionContractExecution(createContractExecutionTransactionForDeveloperRequest: CreateContractExecutionTransactionForDeveloperRequest, xRequestId?: string, options?: any): AxiosPromise<CreateContractExecutionTransactionForDeveloper>;
    /**
     * Initiates an on-chain digital asset transfer from a specified developer-controlled wallet.  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.
     * @summary Create a transfer transaction
     * @param {CreateTransferTransactionForDeveloperRequest} createTransferTransactionForDeveloperRequest Create transaction for developer request
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionTransfer(createTransferTransactionForDeveloperRequest: CreateTransferTransactionForDeveloperRequest, xRequestId?: string, options?: any): AxiosPromise<CreateTransferTransactionForDeveloperResponse>;
    /**
     * Creates a transaction which upgrades a wallet.
     * @summary Create a wallet upgrade transaction
     * @param {CreateWalletUpgradeTransactionForDeveloperRequest} createWalletUpgradeTransactionForDeveloperRequest Creates a transaction for a developer request.
     ...
     * @throws {RequiredError}
     */
    createDeveloperTransactionWalletUpgrade(createWalletUpgradeTransactionForDeveloperRequest: CreateWalletUpgradeTransactionForDeveloperRequest, xRequestId?: string, options?: any): AxiosPromise<CreateWalletUpgradeTransactionForDeveloper>;
    /**
     * Estimates gas fees that will be incurred for a contract execution transaction, given its ABI parameters and blockchain.
     * @summary Estimate fee for a contract execution transaction
     * @param {EstimateContractExecutionTransactionFeeRequest} estimateContractExecutionTransactionFeeRequest Estimate transaction fee request
     ...
     * @throws {RequiredError}
     */
    createTransactionEstimateFee(estimateContractExecutionTransactionFeeRequest: EstimateContractExecutionTransactionFeeRequest, xRequestId?: string, options?: any): AxiosPromise<EstimateTransactionFee>;
    /**
     * Estimates gas fees that will be incurred for a transfer transaction; given its amount, blockchain, and token.
     * @summary Estimate fee for a transfer transaction
     * @param {EstimateTransferTransactionFeeRequest} estimateTransferTransactionFeeRequest Estimate transaction fee request
     ...
     * @throws {RequiredError}
     */
    createTransferEstimateFee(estimateTransferTransactionFeeRequest: EstimateTransferTransactionFeeRequest, xRequestId?: string, options?: any): AxiosPromise<EstimateTransactionFee>;
    /**
     * Confirms that a specified address is valid for a given token on a certain blockchain.
     * @summary Validate an address
     * @param {ValidateAddressRequest} validateAddressRequest Validate address request
     ...
     * @throws {RequiredError}
     */
    getFeeParameters(blockchain?: Blockchain, accountType?: AccountType, options?: any): AxiosPromise<FeeParametersResponse>;
    /**
     * For a nonce-supported blockchain, get the lowest nonce transaction that\'s in QUEUED or SENT or STUCK state for the provided wallet.
     * @summary Get the lowest nonce pending transaction for a wallet
     * @param {Blockchain} [blockchain] Filter by blockchain.
     ...
     * @throws {RequiredError}
     */
    getTransaction(id: string, txType?: TransactionType, xRequestId?: string, options?: any): AxiosPromise<TransactionResponse>;
    /**
     * Lists all transactions. Includes details such as status, source/destination, and transaction hash.
     * @summary List transactions
     * @param {Blockchain} [blockchain] Filter by blockchain.
...
declare class TransactionsApi extends BaseAPI {
     ...
     */
    createDeveloperTransactionAccelerate(id: string, accelerateTransactionForDeveloperRequest: AccelerateTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<AccelerateTransactionForDeveloper, any, {}>>;
    /**
     * Cancels a specified transaction from a developer-controlled wallet. Gas fees may still be incurred.  This is a best-effort operation, it won\'t be effective if the original transaction has already been processed by the blockchain.
     * @summary Cancel a transaction
     * @param {string} id The universally unique identifier of the resource.
     ...
     * @memberof TransactionsApi
     */
    createDeveloperTransactionCancel(id: string, cancelTransactionForDeveloperRequest: CancelTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<CancelTransactionForDeveloper, any, {}>>;
    /**
     * Creates a transaction which executes a smart contract. ABI parameters must be passed in the request. Related transactions may be submitted as a batch transaction in a single call.  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.
     * @summary Create a contract execution transaction
     * @param {CreateContractExecutionTransactionForDeveloperRequest} createContractExecutionTransactionForDeveloperRequest Create transaction for developer request
     ...
     * @memberof TransactionsApi
     */
    createDeveloperTransactionContractExecution(createContractExecutionTransactionForDeveloperRequest: CreateContractExecutionTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<CreateContractExecutionTransactionForDeveloper, any, {}>>;
    /**
     * Initiates an on-chain digital asset transfer from a specified developer-controlled wallet.  You must provide either a `walletId` or a `walletAddress` and `blockchain` pair in the request body.
     * @summary Create a transfer transaction
     * @param {CreateTransferTransactionForDeveloperRequest} createTransferTransactionForDeveloperRequest Create transaction for developer request
     ...
     * @memberof TransactionsApi
     */
    createDeveloperTransactionTransfer(createTransferTransactionForDeveloperRequest: CreateTransferTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<CreateTransferTransactionForDeveloperResponse, any, {}>>;
    /**
     * Creates a transaction which upgrades a wallet.
     * @summary Create a wallet upgrade transaction
     * @param {CreateWalletUpgradeTransactionForDeveloperRequest} createWalletUpgradeTransactionForDeveloperRequest Creates a transaction for a developer request.
     ...
     * @memberof TransactionsApi
     */
    createDeveloperTransactionWalletUpgrade(createWalletUpgradeTransactionForDeveloperRequest: CreateWalletUpgradeTransactionForDeveloperRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<CreateWalletUpgradeTransactionForDeveloper, any, {}>>;
    /**
     * Estimates gas fees that will be incurred for a contract execution transaction, given its ABI parameters and blockchain.
     * @summary Estimate fee for a contract execution transaction
     * @param {EstimateContractExecutionTransactionFeeRequest} estimateContractExecutionTransactionFeeRequest Estimate transaction fee request
     ...
     * @memberof TransactionsApi
     */
    createTransactionEstimateFee(estimateContractExecutionTransactionFeeRequest: EstimateContractExecutionTransactionFeeRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<EstimateTransactionFee, any, {}>>;
    /**
     * Estimates gas fees that will be incurred for a transfer transaction; given its amount, blockchain, and token.
     * @summary Estimate fee for a transfer transaction
     * @param {EstimateTransferTransactionFeeRequest} estimateTransferTransactionFeeRequest Estimate transaction fee request
     ...
     * @memberof TransactionsApi
     */
    createTransferEstimateFee(estimateTransferTransactionFeeRequest: EstimateTransferTransactionFeeRequest, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<EstimateTransactionFee, any, {}>>;
    /**
     * Confirms that a specified address is valid for a given token on a certain blockchain.
     * @summary Validate an address
     * @param {ValidateAddressRequest} validateAddressRequest Validate address request
     ...
     * @memberof TransactionsApi
     */
    getFeeParameters(blockchain?: Blockchain, accountType?: AccountType, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<FeeParametersResponse, any, {}>>;
    /**
     * For a nonce-supported blockchain, get the lowest nonce transaction that\'s in QUEUED or SENT or STUCK state for the provided wallet.
     * @summary Get the lowest nonce pending transaction for a wallet
     * @param {Blockchain} [blockchain] Filter by blockchain.
     ...
     * @memberof TransactionsApi
     */
    getTransaction(id: string, txType?: TransactionType, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<TransactionResponse, any, {}>>;
    /**
     * Lists all transactions. Includes details such as status, source/destination, and transaction hash.
     * @summary List transactions
     * @param {Blockchain} [blockchain] Filter by blockchain.
...
declare const WalletSetsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @param {string} [pageAfter] A collection ID value used for pagination.  It marks the exclusive begin of a page. When provided, the collection resource will return the next n items after the id, with n being specified by pageSize.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither pageAfter nor pageBefore are specified.  SHOULD NOT be used in conjunction with pageBefore.
     * @param {number} [pageSize] Limits the number of items to be returned.  Some collections have a strict upper bound that will disregard this value. In case the specified value is higher than the allowed limit, the collection limit will be used.  If avoided, the collection will determine the page size itself.
     * @param {GetWalletSetsOrderEnum} [order] Specifies the sort order of the collection by &#x60;CreateDate&#x60;.  Valid values: - &#x60;ASC&#x60; – Sort results in ascending order. - &#x60;DESC&#x60; – Sort results in descending order (default).
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getWalletSets: (xRequestId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, order?: GetWalletSetsOrderEnum, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
declare const WalletSetsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getWalletSets(xRequestId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, order?: GetWalletSetsOrderEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WalletSets>>;
    /**
     * Update the name of the wallet set
     * @summary Update a wallet set
     * @param {string} id The universally unique identifier of the resource.
...
declare const WalletSetsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    getWalletSets(xRequestId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, order?: GetWalletSetsOrderEnum, options?: any): AxiosPromise<WalletSets>;
    /**
     * Update the name of the wallet set
     * @summary Update a wallet set
     * @param {string} id The universally unique identifier of the resource.
...
declare class WalletSetsApi extends BaseAPI {
     ...
     * @memberof WalletSetsApi
     */
    getWalletSets(xRequestId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, order?: GetWalletSetsOrderEnum, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<WalletSets, any, {}>>;
    /**
     * Update the name of the wallet set
     * @summary Update a wallet set
     * @param {string} id The universally unique identifier of the resource.
 ...
 * @export
 */
declare const GetWalletSetsOrderEnum: {
    readonly Asc: "ASC";
    readonly Desc: "DESC";
};
type GetWalletSetsOrderEnum = typeof GetWalletSetsOrderEnum[keyof typeof GetWalletSetsOrderEnum];
...
declare const WalletsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getWallets: (address?: string, blockchain?: Blockchain, scaCore?: ScaCore, walletSetId?: string, refId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, order?: GetWalletsOrderEnum, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listWalletBalance: (id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: TokenStandard, pageBefore?: string, pageAfter?: string, pageSize?: number, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listWalletNfts: (id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: TokenStandard, pageBefore?: string, pageAfter?: string, pageSize?: number, xRequestId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
declare const WalletsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listWalletBalance(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: TokenStandard, pageBefore?: string, pageAfter?: string, pageSize?: number, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Balances>>;
    /**
     * Fetches the info for all NFTs stored in a single developer-controlled wallet, using the wallets unique identifier.
     * @summary Get NFTs for a wallet
     * @param {string} id Wallet ID
     ...
     * @throws {RequiredError}
     */
    listWalletNfts(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: TokenStandard, pageBefore?: string, pageAfter?: string, pageSize?: number, xRequestId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Nfts>>;
    /**
     * Updates info metadata of a wallet.
     * @summary Update a wallet
     * @param {string} id The universally unique identifier of the resource.
...
declare const WalletsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    getWallets(address?: string, blockchain?: Blockchain, scaCore?: ScaCore, walletSetId?: string, refId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, order?: GetWalletsOrderEnum, xRequestId?: string, options?: any): AxiosPromise<Wallets>;
    /**
     * Retrieves a list of all wallets that match the specified parameters. Wallet balances update automatically after each transfer.  **Note**: On Aptos, this endpoint only returns balances for tokens stored in primary storage. Tokens held in [AIP-21](https://github.com/aptos-labs/aptos-core/releases/tag/aptos-node-v1.5.0) secondary storage are excluded from balance queries and deposit notifications to prevent incorrect or misleading results from secondary storage-based state changes.
     * @summary List wallets with balances
     * @param {Blockchain} blockchain Filter by blockchain.
     ...
     * @throws {RequiredError}
     */
    listWalletBalance(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: TokenStandard, pageBefore?: string, pageAfter?: string, pageSize?: number, xRequestId?: string, options?: any): AxiosPromise<Balances>;
    /**
     * Fetches the info for all NFTs stored in a single developer-controlled wallet, using the wallets unique identifier.
     * @summary Get NFTs for a wallet
     * @param {string} id Wallet ID
     ...
     * @throws {RequiredError}
     */
    listWalletNfts(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: TokenStandard, pageBefore?: string, pageAfter?: string, pageSize?: number, xRequestId?: string, options?: any): AxiosPromise<Nfts>;
    /**
     * Updates info metadata of a wallet.
     * @summary Update a wallet
     * @param {string} id The universally unique identifier of the resource.
...
declare class WalletsApi extends BaseAPI {
     ...
     * @memberof WalletsApi
     */
    getWallets(address?: string, blockchain?: Blockchain, scaCore?: ScaCore, walletSetId?: string, refId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, order?: GetWalletsOrderEnum, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<Wallets, any, {}>>;
    /**
     * Retrieves a list of all wallets that match the specified parameters. Wallet balances update automatically after each transfer.  **Note**: On Aptos, this endpoint only returns balances for tokens stored in primary storage. Tokens held in [AIP-21](https://github.com/aptos-labs/aptos-core/releases/tag/aptos-node-v1.5.0) secondary storage are excluded from balance queries and deposit notifications to prevent incorrect or misleading results from secondary storage-based state changes.
     * @summary List wallets with balances
     * @param {Blockchain} blockchain Filter by blockchain.
     ...
     * @memberof WalletsApi
     */
    listWalletBalance(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: TokenStandard, pageBefore?: string, pageAfter?: string, pageSize?: number, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<Balances, any, {}>>;
    /**
     * Fetches the info for all NFTs stored in a single developer-controlled wallet, using the wallets unique identifier.
     * @summary Get NFTs for a wallet
     * @param {string} id Wallet ID
     ...
     * @memberof WalletsApi
     */
    listWalletNfts(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: TokenStandard, pageBefore?: string, pageAfter?: string, pageSize?: number, xRequestId?: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<Nfts, any, {}>>;
    /**
     * Updates info metadata of a wallet.
     * @summary Update a wallet
     * @param {string} id The universally unique identifier of the resource.
 ...
 * @export
 */
declare const GetWalletsOrderEnum: {
    readonly Asc: "ASC";
    readonly Desc: "DESC";
};
type GetWalletsOrderEnum = typeof GetWalletsOrderEnum[keyof typeof GetWalletsOrderEnum];
